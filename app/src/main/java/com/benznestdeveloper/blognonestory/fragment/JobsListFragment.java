...
import com.benznestdeveloper.blognonestory.adapter.MyJobsRecyclerViewAdapter;
import com.benznestdeveloper.blognonestory.dao.jobs.JobsDao;
import com.benznestdeveloper.blognonestory.dialog.SearchJobsDialog;
...
//
    ...
    private void selectNode(JobsDao node) {
        if (MyUtils.isTablet()) {
