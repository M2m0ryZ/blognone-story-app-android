...
public class SettingFragment extends Fragment {
    ...
    private SwitchCompat switchEnableDisplayDetailTopic;
    private SwitchCompat switchEnableTopicCommentTab;
    ...
    private void initView(View v) {
        ...
        switchEnableDisplayDetailTopic = (SwitchCompat) v.findViewById(R.id.switch_enable_display_detail_topic);
        switchEnableDisplayDetailTopic.setChecked(MySetting.isSettingShowDetailOfTopic(getContext()));
        switchEnableDisplayDetailTopic.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                MySetting.setSettingShowDetailOfTopic(getContext(), b);
            }
        });

        switchEnableTopicCommentTab = (SwitchCompat) v.findViewById(R.id.switch_enable_topic_comment_tab);
        switchEnableTopicCommentTab.setChecked(MySetting.isSettingEnableTopicCommentTab(getContext()));
        switchEnableTopicCommentTab.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                MySetting.setSettingEnableTopicCommentTab(getContext(), b);
            }
        });
    }
