...
public class MyUtils {
    ...
    public static void openNodeInBrowser(Activity activity, int nodeId) {
        openUrlInBrowser(activity, "https://www.blognone.com/node/" + nodeId);
    }
    ...
    public static void openJobsInBrowser(Activity activity, JobsDao job) {
        if (job != null) {
    ...
    public static void copyNodeToClipboard(Context context, int nodeId) {
        String url = "https://www.blognone.com/node/" + nodeId;
        copyToClipboard(context, url);
    }

    public static void copyJobsToClipboard(Context context, JobsDao job) {
