package com.panuwatjan.greendao;
...
public class MyDaoGenerator {
    public static void main(String[] args) throws Exception {
        Schema schema = new Schema(1, "com.panuwatjan.blognonestory");
        ...
        schema = setSchemaBlognoneJobsCache(schema);
        schema = setSchemaBlognoneFavoriteJobs(schema);
    ...
    private static Schema setSchemaBlognoneJobsCache(Schema schema) {
        Entity entity = schema.addEntity("BlognoneJobsCache");
    ...
    private static Schema setSchemaBlognoneFavoriteJobs(Schema schema) {
        Entity entity = schema.addEntity("BlognoneFavoriteJobs");
